...
run-witness-generation:
	...
	RUST_LOG="error" co-noir generate-witness --input out/merged-inputs/Prover.toml.1.shared --circuit schnapsen/target/schnapsen.json --protocol REP3 --config configs/party1.toml --out out/witness/witness.gz.1.shared &
	RUST_LOG="error" co-noir generate-witness --input out/merged-inputs/Prover.toml.2.shared --circuit schnapsen/target/schnapsen.json --protocol REP3 --config configs/party2.toml --out out/witness/witness.gz.2.shared
...
run-prove:
	...
	RUST_LOG="error" co-noir build-and-generate-proof --witness out/witness/witness.gz.1.shared --circuit schnapsen/target/schnapsen.json --crs crs/bn254_g1.dat --protocol REP3 --hasher keccak --config configs/party1.toml --out out/proofs/proof.1.dat --public-input out/proofs/public-input.1.dat & 
	RUST_LOG="error" co-noir build-and-generate-proof --witness out/witness/witness.gz.2.shared --circuit schnapsen/target/schnapsen.json --crs crs/bn254_g1.dat --protocol REP3 --hasher keccak --config configs/party2.toml --out out/proofs/proof.2.dat --public-input out/proofs/public-input.2.dat
